...
%  highpass filter, H of the specified TYPE and size M-by-N. Valid values
%  for TYPE, D, and n are:
%
%  'ideal'    Ideal highpass filter with cutoff frequency D0. n nneed not
...
% The transfer function Hhp of a highpass filter is 1 - Hlp, where Hlp is
% the transfer function of the corresponding lowpass filter. Thus, we can
