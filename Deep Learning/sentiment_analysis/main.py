...
best_L = 0.01
theta, theta_0 = \
   p1.pegasos(train_bow_features, train_labels, best_T, best_L)
test_result = p1.classify(test_bow_features, theta, theta_0)
print("{:43} {:.4f}".format("Test accuracy for average perceptron:", p1.accuracy(test_result, test_labels)))
print("{:43} [{} {:.4f}]".format("Theta = ", theta, theta_0))
